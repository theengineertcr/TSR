...
replication
{
    ...
    reliable if( Role == ROLE_Authority )
        ...
        ClientOnLoggedIn, ClientRoundStarted, ClientReloadForPawn,
        ...
        ClientAITriggerEffectEvent, //ClientAIDroppedAllWeapons,
    ...
    reliable if( Role < ROLE_Authority )
        ...
        ServerSetMPLoadOutPocketItem, ServerSetMPLoadOutPocketWeapon, ServerSetMPLoadOutSpecComplete, ServerChangePlayerTeam,
...
simulated function UpdateFocus()
{
    ...
    for ( ct = 0; ct < FocusInterfaces.Length; ct++ )
        if (FocusInterfaceWantsUpdate[ct] == 1)
            FocusInterfaces[ct].PostUpdate();
...
ignores ActivateViewport;
    ...
    exec function GiveDefaultCommand()
    {
        if  (
            ...
            GetCommandInterface().GiveDefaultCommand();
    }
...
exec function GiveCommand(int CommandIndex)
{
    ...
    CCI.GiveCommandIndex(CommandIndex);
}
